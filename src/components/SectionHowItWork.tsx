...
const SectionHowItWork: FC<SectionHowItWorkProps> = ({
  ...
  return (
    <div
      className={`nc-SectionHowItWork  ${className} container  px-2 py-20 lg:py-40`}
      data-nc-id="SectionHowItWork"
    >
      <Heading isCenter>How it works ?</Heading>
      <div className="mt-4 lg:mt-20 overflow-hidden  grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Card 1 */}
