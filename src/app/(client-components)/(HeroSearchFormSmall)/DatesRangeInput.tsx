    ...
    <Popover className={`DateRangeInput z-10 relative flex ${className}`}>
      {({ open }) => (
        <>
          ...
          >
            <Popover.Panel className="absolute left-0 lg:left-1/2 z-50  mt-3 top-full w-screen max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
              <div className="overflow-scroll rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5 bg-white dark:bg-neutral-800 p-8">
                <DatePicker
                  selected={startDate}
